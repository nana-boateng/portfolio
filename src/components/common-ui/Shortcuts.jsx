...
export default function Shortcuts() {
  const style =
    "hidden mx-4 w-56 h-48 shadow-md lg:flex lg:flex-col xl:flex xl:flex-col lg:hover:scale-105 duration-100 lg:w-64 xl:w-64";
  const cardStyle = "bg-bone-400";
  ...
  return (
    <div className="flex flex-row mx-auto my-4 animate-fade-in-right">
      <Card
        colour={cardStyle}
      ...
      <Card colour={cardStyle} style={style}>
        <Project
          description={testDescription}
          link={testLink}
          photo={testPhoto}
